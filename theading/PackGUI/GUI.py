import sys
from PySide2.QtWidgets import QButtonGroup,QSpacerItem, QComboBox,QRadioButton,QFormLayout,QHBoxLayout, QApplication, QWidget, QInputDialog, QLineEdit, QFileDialog,QPushButton,QMessageBox,QLabel,QGridLayout,QGroupBox,QVBoxLayout
...
class App(QWidget):
    ...
    def openFileNameDialog(self):    
        ...
        fileName, _ = QFileDialog.getOpenFileName(self,"Select profile", "","CSV Files (*.csv)", options=options)
        if fileName:
